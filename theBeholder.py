...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.main_ui = win111.Ui_MainWindow()
        self.main_ui.setupUi(self)
...
######################################################################
                    ...
                    def handleButton(button):
                        if button == okButton:
                            ...
                            if dialog.inpkod.text() == '1917':
                                ...
                                QMessageBox("Сообщение", "Зарегистрированно.", buttons=QMessageBox.Ok)
    ...
    def on_button_start(self):
        ...
        self.win.setMouseEnabled(x=True, y=True)
        layout = QGridLayout()
        self.main_ui.widget.setLayout(layout)
        self.d1 = [time.time()]
        self.d2 = [0]
        self.d3 = [0]
        self.d4 = [0]
        ...
        self.d9 = [0]
        # self.d4 = [0]
        self.curve = self.win.plot(self.d1, self.d2, pen=pg.mkPen(color=(255, 0, 0)), symbol='o', symbolSize=5, symbolBrush="red")
        self.curve2 = self.win.plot(self.d1, self.d3, pen=pg.mkPen(color=(255, 255, 0)), symbol='+', symbolSize=5, symbolBrush="w")
        self.curve3 = self.win.plot(self.d1, self.d4, pen=pg.mkPen(color=(255, 0, 255)), symbol='t', symbolSize=5, symbolBrush="c")
        self.curve4 = self.win.plot(self.d1, self.d5, pen=pg.mkPen(color=(0, 255, 0)), symbol='t1', symbolSize=5, symbolBrush="green")
        self.curve5 = self.win.plot(self.d1, self.d6, pen=pg.mkPen(color=(0, 255, 255)), symbol='t2', symbolSize=5, symbolBrush="g")
        self.curve6 = self.win.plot(self.d1, self.d7, pen=pg.mkPen(color=(0, 0, 255)), symbol='p', symbolSize=5, symbolBrush="g")
        self.curve7 = self.win.plot(self.d1, self.d8, pen=pg.mkPen(color=(255, 100, 0)), symbol='h', symbolSize=5, symbolBrush="g")
        self.curve8 = self.win.plot(self.d1, self.d9, pen=pg.mkPen(color=(255, 0, 100)), symbol='star', symbolSize=5, symbolBrush="g")
        # self.curve.clear()
        # self.curve2.clear()
        # self.curve3.clear()
        # self.curve4.clear()
        ...
        # # self.win.plot([1, 2, 3, ], [7, 1, 20], symbol='star')
        layout.addWidget(self.win, 0, 1, 3, 1)
        # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        try:
    ...
    def on_change(self, data_):
        ...
        self.d3.append(data_[1])
        self.d4.append(data_[2])
        self.d5.append(data_[3])
        self.d6.append(data_[4])
        self.d7.append(data_[5])
        self.d8.append(data_[6])
        self.d9.append(data_[7])

        if self.d1.__len__() > 15:
            self.d1.pop(0)
            self.d2.pop(0)
            self.d3.pop(0)
            self.d4.pop(0)
        ...
        self.curve3.setData(self.d4)
        self.curve3.setPos(self.ptr1, 0)
        self.curve4.setData(self.d5)
        self.curve4.setPos(self.ptr1, 0)
        self.curve5.setData(self.d6)
        self.curve5.setPos(self.ptr1, 0)
        self.curve6.setData(self.d7)
        self.curve6.setPos(self.ptr1, 0)
        self.curve7.setData(self.d8)
        self.curve7.setPos(self.ptr1, 0)
        self.curve8.setData(self.d9)
        self.curve8.setPos(self.ptr1, 0)
